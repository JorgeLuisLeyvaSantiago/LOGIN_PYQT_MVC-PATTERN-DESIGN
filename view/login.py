...
"	background-color: qlineargradient(spread:pad,x1:0,y1:0,x2:0, y2:1, stop:0.0646766 rgba(54,62,130,255), stop:0.412935 rgba(135,121,221,170), stop:0.781095 rgba(255,255,255,255), stop:0.905473 rgba(255,255,255,255));\n"
"border-radius:20px;\n"
"}\n"
"\n"
"\n"
...
"background-color: rgba(0,0,0,0%);")
        self.label_4.setPixmap(QPixmap(u"view\logo.png"))
        self.label_4.setGeometry(170,45,120,90)
        self.label_4.setScaledContents(True) # Ajuste dinámico con la pantalla
        self.contrasena_incorrecta = QLabel(self.frame)
        self.contrasena_incorrecta.setObjectName(u"contrasena_incorrecta")
        self.contrasena_incorrecta.setGeometry(QRect(170, 300, 140, 16))
...
"")
        ...
        self.usuario_incorrecto.setGeometry(QRect(170, 210, 140, 16))
